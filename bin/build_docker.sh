...
docker build \
    ...
    --build-arg rabbitmqcURL=http://lsst-web.ncsa.illinois.edu/~hwin16/packages/rabbitmq-c/v0.10.0.tar.gz \
    ...
    --build-arg daqURL=http://lsst-web.ncsa.illinois.edu/~hwin16/packages/daq/R4-V2.3.tgz \
