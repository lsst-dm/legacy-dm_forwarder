...
parser = argparse.ArgumentParser(description="Running test images for forwarder")
parser.add_argument("-i", "--image", required=True)
image_id = parser.parse_args().image
...
msg['ACK_ID'] = 0
msg['FILENAME'] = f'http://localhost:8000/test.header'
msg['IMAGE_ID'] = image_id
msg['REPLY_QUEUE'] = 'at_foreman_ack_publish'
ch.basic_publish('message', 'f99_consume', yaml.dump(msg))
